import { Camera, Mic, Ruler, Check } from "lucide-react";
    ...
    <div className="grid grid-cols-2 gap-6">
      ...
      <div className="rounded-2xl border-2 border-border bg-surface p-6">
        ...
        <textarea
          ...
          placeholder="e.g. wall between kitchen and hall is here on-site but not on the plan"
          rows={5}
      ...
      {/* Tags */}
      <div className="rounded-2xl border-2 border-border bg-surface p-6 col-span-2">
      ...
      <div className="rounded-2xl border-2 border-border bg-surface p-6 col-span-2">
        ...
        <input
          ...
          placeholder="e.g. wall is 3.40 m long, 2.60 m tall"
